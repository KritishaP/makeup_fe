    ...
    <footer className="bg-dark text-light ">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:px-8 px-5 py-16">
        ...
        <ul  >
          ...
          <li > <a href="#">
            <i className="fa-brands fa-facebook py-2 hover:text-orange-200"></i>
          </a></li>
          <li><a href="#"><i className="fa-brands fa-square-instagram py-2 hover:text-orange-200"></i></a></li>
          <li> <a href="#"><i className="fa-brands fa-square-x-twitter py-2 hover:text-orange-200"></i></a></li>
        </ul>
