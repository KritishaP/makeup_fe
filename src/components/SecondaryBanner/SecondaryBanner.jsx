...
const SecondaryBanner = () => {
  return (<>
    <div className="banner__secondary container flex items-center justify-around mx-auto md:px-20 bg-pinkish mb-10 ">
      <div className="md:w-96">
        <h3 className="font-krona mb-4 text-dark md:text-xl">
